...
var dataX = new Array('JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JULY', 'AUO', 'SEP', 'OCT', 'NOV', 'DEC');
var dataY1,dataY2,dataY1Sum=0,dataY2Sum=0;
...
var data = new Array();
for( var i = 0;i <12;i++){
	data.push(Math.ceil(Math.random()*3000));  
}
return data;
}
change();
